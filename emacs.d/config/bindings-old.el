...
(global-unset-key [M-S-left])
(global-unset-key [M-S-right]) (global-set-key [(f3)] 'global-auto-highlight-symbol-mode)
(global-set-key [M-S-right] 'ahs-forward)
(global-set-key [M-S-left] 'ahs-bacward)
