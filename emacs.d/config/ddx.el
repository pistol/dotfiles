...
(defvar ddx-mode-font-lock-keywords
  (list
   ...
   ;(cons "\\(?:L\\)\\(\\w+/*\\)+" font-lock-comment-face)
   (cons (concat "\\<" (regexp-opt ddx-dex-opcode-list) "\\>")
         font-lock-builtin-face)
   (cons (concat "\\.\\<" (regexp-opt '("class" "super" "implements" "field"
                                        "subannotation" "annotation"
                                        "enum" "method" "registers" "locals" "array-data"
                                        "packed-switch"
                                        "sparse-switch" "catch" "catchall" "line"
                                        "parameter" "local"
                                        "prologue" "epilogue"
                                        "source"
                                        "restart local"
   ...
   (cons (concat "\\.end \\<" (regexp-opt '("field" "subannotation" "annotation" "method" "array-data"
                                            "packed-switch" "sparse-switch" "parameter" "local"
                                            )) "\\>")
         font-lock-preprocessor-face)
   (cons (concat "\\<" (regexp-opt '("public" "private" "protected" "static" "final" "synchronized" "bridge" "varargs"
                                     "native" "abstract" "strictfp" "synthetic" "constructor" "declared-synchronized"
                                     "interface" "enum" "annotation" "volatile" "transient" "system"
                                     )) "\\>")
         font-lock-keyword-face)
   (cons "\\<[vp][[:digit:]]+\\>" font-lock-variable-name-face)
   (cons "\[-+\]?0x[[:xdigit:]]+" font-lock-constant-face)
   (cons "\[-+\]?[[:digit:]]+" font-lock-constant-face)
   ))
...
(font-lock-add-keywords 'smali-mode
  '(
    ;;("\\W\\(L\\)\\(\\(?:\\w+/?\\)+\\);\\(\\)?"
    ("\\W\\(L\\)\\(\\(?:\\w+/?\\)+\\)"
    ...
    ("\\s\"\\|\\s|" 0 font-lock-comment-face t)
    ("->\\(<?\\w+>?\\)" 1 font-lock-type-face t)
;;    ("L" (0 font-lock-comment-face)
;;        ("\\(\\w+/?\\)+;" nil nil (0 font-lock-variable-name-face)))
   )
)
